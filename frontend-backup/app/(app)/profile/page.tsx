          ...
          <div className="flex overflow-x-auto gap-8 pb-10 hide-scrollbar -mx-12 px-12">
            {[
              ...
              >
                ...
                <div className={cn("w-20 h-20 rounded-[28px] flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform", achievement.bg, achievement.color)}>
                  {achievement.icon}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-strong p-10 rounded-[48px] border border-white/5 shadow-3xl space-y-10 relative overflow-hidden">
               ...
               <div className="flex items-center justify-between relative z-10">
                 ...
                 <div className="w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center animate-pulse border border-secondary/20">
