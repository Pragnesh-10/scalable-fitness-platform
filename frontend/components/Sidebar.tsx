  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      document.documentElement.style.setProperty(
        '--sidebar-width', 
        isDesktop ? (isCollapsed ? '88px' : '280px') : '0px'
      );
    }
  }, [isCollapsed]);
    ...
    <div className="flex flex-col h-full overflow-x-hidden pt-2">
      ...
      <div className={cn("flex items-center gap-4 mb-10 px-2 transition-all duration-500", collapsed ? "justify-center" : "")}>
        ...
        {!collapsed && (
          ...
          >
            <span className="text-2xl font-black italic tracking-tighter text-white font-space uppercase leading-none">FITPULSE</span>
