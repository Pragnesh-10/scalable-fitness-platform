    ...
    <div className="min-h-screen bg-[#030303] text-white selection:bg-[#6C63FF]/30">
      ...
      <nav className="fixed top-0 left-0 w-full z-[100] px-6 py-8 flex justify-between items-center bg-gradient-to-b from-[#030303] to-transparent">
        ...
        <div className="hidden md:flex items-center gap-12 text-[10px] font-space font-black tracking-[0.3em] text-white/40 uppercase">
          <a href="#features" className="hover:text-[#6C63FF] transition-colors">CAPABILITIES</a>
          <a href="#tech" className="hover:text-secondary transition-colors">TECHNOLOGY</a>
          <a href="#community" className="hover:text-white transition-colors">COHORT</a>
        </div>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/assets/generated/realistic_fitness_hero_1777436506277.png" 
            alt="Hero Background" 
