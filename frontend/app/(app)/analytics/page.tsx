          ...
          {metrics.map((m) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-10 relative z-10">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center border border-white/10 transition-all group-hover:scale-110 shadow-xl" style={{ backgroundColor: `${m.color}15` }}>
